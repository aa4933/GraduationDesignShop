...
<title>商品类别</title><script language="javascript" src="js/hsgrili.js"></script><link rel="stylesheet" href="css.css" type="text/css">
</head>
...
//zoxngxetxoxngjxvi
  ...
  <tr>
    ...
    <td width="70" align="center"><a href="del.php?id=<?php echo mysql_result($query,$i,"id");?>&tablename=shangpinleibie" onclick="return confirm('真的要删除？')">删除</a> <a href="shangpinleibie_updt.php?id=<?php echo mysql_result($query,$i,"id");?>">修改</a></td>
  </tr>
  	<?php
	}
}
