...
if ($addnew=="1" )
{
	...
	$sql="update xinwentongzhi set zhaiyao='$zhaiyao', biaoti='$biaoti',leibie='$leibie',neirong='$neirong',shouyetupian='$shouyetupian',dianjilv='$dianjilv',tianjiaren='$tianjiaren' where id= ".$id;
	mysql_query($sql);
...
<table width="100%" border="1" align="center" cellpadding="3" cellspacing="1" bordercolor="#00FFFF" style="border-collapse:collapse"> 
      ...
      <tr>
        <td>摘要：</td>
        <td><textarea name="zhaiyao" cols="80" rows="5" id="zhaiyao"><?php echo mysql_result($query,$i,zhaiyao);?></textarea></td>
      </tr>
      <tr><td>内容：</td><td><textarea name="neirong" style="width:700px;height:200px;visibility:hidden;"><?php echo mysql_result($query,$i,neirong);?></textarea></td>
