...
if ($addnew=="1" )
{
	...
	$sql="insert into xinwentongzhi(biaoti,leibie,neirong,shouyetupian,dianjilv,tianjiaren,zhaiyao) values('$biaoti','$leibie','$neirong','$shouyetupian','$dianjilv','$tianjiaren','$zhaiyao') ";
	mysql_query($sql);
...
<table width="100%" border="1" align="center" cellpadding="3" cellspacing="1" bordercolor="#00FFFF" style="border-collapse:collapse">    
	...
	<tr>
	  <td>摘要：</td>
	  <td><textarea name="zhaiyao" cols="80" rows="5" id="zhaiyao"></textarea></td>
    </tr>
